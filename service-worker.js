...
var PRECACHE  = [
  ...
  "./js/reel_strips.js?v=2.0.0",
  "./js/combo_positions.js?v=2.0.0",
  "./js/win_pools.js?v=2.0.0",
  "./js/paytable.js?v=2.0.0",
  "./js/nowin_pool.js?v=2.0.0",
  "./js/wabc.js?v=2.0.0",
  "./js/progressive.js?v=2.0.0",
  "./js/broadcast-init.js?v=2.0.0",
  "./js/game.js?v=2.0.0",
  "./assets/apple-touch-icon.png?v=2.0.0",
  "./assets/banner_art_work.jpg?v=2.0.0",
  "./assets/bell_ring.mp3?v=2.0.0",
  "./assets/favicon-32.png?v=2.0.0",
  "./assets/icon-192.png?v=2.0.0",
  "./assets/icon-512.png?v=2.0.0",
  "./assets/jackpot_sisters.png?v=2.0.0",
  "./assets/progressive_pup.png?v=2.0.0",
  "./assets/red_spin_music.mp3?v=2.0.0",
  "./assets/reel_spin_loop.wav?v=2.0.0",
  "./assets/reel_start.wav?v=2.0.0",
  "./assets/reel_stop.wav?v=2.0.0",
  "./assets/splash_screen.jpg?v=2.0.0",
  "./assets/splash_welcome.wav?v=2.0.0",
  "./assets/sym_1bar.svg?v=2.0.0",
  "./assets/sym_2bar.svg?v=2.0.0",
  "./assets/sym_3bar.svg?v=2.0.0",
  "./assets/sym_blue_7.svg?v=2.0.0",
  "./assets/sym_cherry.svg?v=2.0.0",
  "./assets/sym_red_7.svg?v=2.0.0"
];
